...
|-----------|----------------------------|-----------------------|------------------------------------|
| POST      | /api/v1/queue-in           | Queue in              | [Link](./v1/match/queue-in.md)     |
...
| GET       | /api/v1/auth/login         | Login                 | [Link](./v1/profile/history.md)    |
| GET       | /api/v1/auth/logout        | Logout                | [Link](./v1/profile/history.md)    |
| GET       | /api/v1/auth/refresh       | Refresh access token  | [Link](./v1/profile/history.md)    |
